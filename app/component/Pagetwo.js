  ...
  const itemRefs = useRef([]);
    ...
    return (
        <div id='HowItWorks' className=' relative'>
          ...
          <div className='container mx-auto px-0 xl:px-[128px] 2xl:px-[178px]'>
            <h1 className='p2fltracker text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[48px] 2xl:text-[64px] pt-[68px] sm:pt-[108px] md:pt-[128px] lg:pt-[138px] xl:pt-[158px] 2xl:pt-[170px] relative'>Flacon Tracker 
              <svg className='absolute top-[45%] left-[20%] xl:block hidden' xmlns="http://www.w3.org/2000/svg" width="201" height="189" viewBox="0 0 201 189" fill="none">
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 gap-[14px] sm:gap-[15px] md:gap-[16px] lg:gap-[20px] xl:gap-[24px] 2xl:gap-[31px] p-[20px] sm:p-[24px] md:p-[32px] lg:p-[36px] xl:p-[40px] 2xl:p-[45px] 2xl:h-[472.37px]'>

          <div>
             <div className="p2cardd p-[20px] sm:p-[24px] md:p-[32px] lg:p-[36px] xl:p-[40px] 2xl:p-[45px] h-full flex flex-col justify-between sm:items-start items-center">
              <h3 className="connectto text-[14px] sm:text-[15px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[32px] sm:text-start text-center">Connect to <br /> Telegram</h3>
              ...
              <p className="addfa text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] sm:text-start text-center">Add Flacon Tracker to <br /> your Telegram.</p>
            </div>
            </div>

           <div>
             <div className="p2cardd p-[20px] sm:p-[24px] md:p-[32px] lg:p-[36px] xl:p-[40px] 2xl:p-[45px] h-full flex flex-col justify-between sm:items-start items-center">
              <h3 className="connectto text-[14px] sm:text-[15px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[32px] sm:text-start text-center">Set Your <br /> Parameters</h3>
              ...
              <p className="addfa text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] sm:text-start text-center">Customize your tracking  <br /> preferences.</p>
            </div>
            </div>

            <div className=''>
             <div className="p2cardd p-[20px] sm:p-[24px] md:p-[32px] lg:p-[36px] xl:p-[40px] 2xl:p-[45px] h-full flex flex-col justify-between sm:items-start items-center">
              <h3 className="connectto text-[14px] sm:text-[15px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[32px] sm:text-start text-center">Receive Alerts</h3>
              ...
              <p className="addfa text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] sm:text-start text-center">Get real-time notifications<br /> on trending launches.</p>
            </div>
            </div>
