...
<stop offset="1" stop-color="white" stop-opacity="0"/>
          ...
          <h1 className='p3roadmp text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[48px] 2xl:text-[60px] pb-[32px] sm:pb-[36px] md:pb-[40px] lg:pb-[48px] xl:pb-[64px] 2xl:pb-[86px] pt-[35px] sm:pt-[50px] md:pt-[80px] lg:pt-[110px] xl:pt-[140px] 2xl:pt-[185px]'>Roadmap</h1>
          <svg className='absolute top-[8%] left-[34.5%]' xmlns="http://www.w3.org/2000/svg" width="201" height="189" viewBox="0 0 201 189" fill="none">
