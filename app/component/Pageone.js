  ...
  useEffect(() => {
    ...
    return (
      <div id='Features' className='posigoandsa '>
        <div className='container mx-auto pt-[40px] sm:pt-[48px] md:pt-[64px] lg:pt-[96px] xl:pt-[128px] 2xl:pt-[150px] sm:px-0 px-6'>
          


          <h1 className='p1h1 text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[48px] 2xl:text-[60px] relative'>
            ...
            <svg className='absolute top-[15.5%] right-[22.5%] xl:block hidden' xmlns="http://www.w3.org/2000/svg" width="157" height="178" viewBox="0 0 157 178" fill="none">
          ...
          <h2 className='p1h2 pt-[32px] text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[20px] 2xl:text-[24px]'>
            Persona Wallet supported by Naxion Network Store all of your crypto and NFTs in one <br className='hidden sm:block' /> 
